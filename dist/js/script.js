...
function forms() {
  const modals = __webpack_require__(/*! ./modals */ "./src/js/modules/modals.js");
  ...
  function showThanksModal(message) {
    ...
    modals.openCloseModal('show', 'hide');
    ...
    setTimeout(() => {
      ...
      modals.openCloseModal('hide', 'show', '');
    }, 4000);
  }
}
...
window.addEventListener('DOMContentLoaded', () => {
  const calc = __webpack_require__(/*! ./modules/calc */ "./src/js/modules/calc.js"),
        ...
        slides = __webpack_require__(/*! ./modules/slides */ "./src/js/modules/slides.js"),
